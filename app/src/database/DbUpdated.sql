...
INSERT INTO `categories` VALUES (1,'comida','2023-04-23 02:55:18','2023-04-23 02:55:18','comidas.jpg'),(2,'artesanias','2023-04-23 02:55:18','2023-04-23 02:55:18','artesanias.jpg'),(3,'pinturas','2023-04-23 02:55:18','2023-04-23 02:55:18','esculturas.jpg'),(4,'esculturas','2023-04-23 02:55:18','2023-04-23 02:55:18','pinturas.jpg');
...
INSERT INTO `sequelizemeta` VALUES ('20230422192612-create-rol.js'),('20230422193020-create-users.js'),('20230422195202-create-categories.js'),('20230422201035-create-products.js'),('20230601032844-create-slider-banner.js');
/*!40000 ALTER TABLE `sequelizemeta` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sliderbanners`
--

DROP TABLE IF EXISTS `sliderbanners`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sliderbanners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `sliderbanners`
--

LOCK TABLES `sliderbanners` WRITE;
/*!40000 ALTER TABLE `sliderbanners` DISABLE KEYS */;
INSERT INTO `sliderbanners` VALUES (1,'banner.png','2023-06-01 00:48:54','2023-06-01 00:48:54'),(2,'image2.jpg','2023-06-01 00:49:37','2023-06-01 00:49:37'),(3,'public.jpg','2023-06-01 00:49:37','2023-06-01 00:49:37'),(4,'error.png','2023-06-01 01:37:00','2023-06-01 01:37:00');
/*!40000 ALTER TABLE `sliderbanners` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-06-03 14:54:40
